...
/// use url::Url;
///
/// let wasm = "bafybeihykuzis3bwavlvcghn3uglsimt5bzimqmyonpkft5aighnwk22mm".to_string();
...
mod test {
        ...
        assert_eq!(
            ...
            Ipld::Map(BTreeMap::from([
                (
                    RESOURCE_KEY.into(),
                    Ipld::String(
                        "ipfs://bafybeihykuzis3bwavlvcghn3uglsimt5bzimqmyonpkft5aighnwk22mm".into()
                    )
                ),
    ...
    fn ipld_cid_trials() {
        ...
        let ipld = libipld::ipld!({"input":
                        ...
                        "nnc": "", "op": "wasm/run",
                        "rsc": "ipfs://bafybeihykuzis3bwavlvcghn3uglsimt5bzimqmyonpkft5aighnwk22mm"});
