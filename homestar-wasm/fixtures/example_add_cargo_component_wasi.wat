(component
  (core module (;0;)
    ...
    (func (;14;) (type 1) (param i32 i32 i32 i32) (result i32)
      local.get 0
      local.get 1
      local.get 2
      local.get 3
    ...
    (export "add-one" (func 17))
    (export "add-two" (func 18))
  ...
  (alias core export 0 "add-two" (core func (;2;)))
  (func (;2;) (type 0) (canon lift (core func 2)))
